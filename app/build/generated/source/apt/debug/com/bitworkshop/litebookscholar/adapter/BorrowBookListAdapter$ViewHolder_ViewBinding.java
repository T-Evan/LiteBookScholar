...
public class BorrowBookListAdapter$ViewHolder_ViewBinding<T extends BorrowBookListAdapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public BorrowBookListAdapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
